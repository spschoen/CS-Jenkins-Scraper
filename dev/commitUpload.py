...
try:
    log = open(log_dir + "ant.log", "r")
except:
    # traceback.print_exc()
    print("asdf")

# Compile failed AND /ts_test/ -> TS COMPILE FAILED
# Compile failed AND /src/     -> ST COMPILE FAILED
# Compile failed AND /test/    -> ST COMPILE FAILED (Third flag?)
